...
This page, however, describes a unofficial pseudo code text format, inspired by Fancade's script blocks made by @Isaglish, @JP16D, @Qma, and @Vex Ave on Discord.
