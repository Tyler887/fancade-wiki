...
This page, however, describes a unofficial puseudo code text format, inspired by Fancade's script blocks made by @Isaglish, @JP16D, @Qma, and @Vex Ave on Discord.

[[_TOC_]]

# Fancade Coding Text Format

This Format will be a basis when sharing or suggesting some codes and code solutions during script discussions. Take this as an easier way to share or suggest a code program instead doing it in fancade and go back to fancade server #scripting channel. Well in case of people that couldn't understand this... Sorry we can't do anything about it ~~:P~~, no jokes! Do the thing in Fancade, screenshot it and share it to them.
