Players with Fancade beta have early access to new features, so those people can report bugs and avoid everyone from running into them when the official update gets released.
